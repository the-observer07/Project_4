...
var FinancialTicker = function (props) {
    var statusClassName = props.change ? stylesFinancial.tickerChangePositive : stylesFinancial.tickerChangeNegative;
    return (React__namespace.createElement("div", { "data-id": props.id, className: [styles.tickerItem, stylesFinancial.tickerItemFinancial].join(' ') },
        ...
        React__namespace.createElement("div", { className: stylesFinancial.tickerStats },
            React__namespace.createElement("img", { className: stylesFinancial.tickerMovement, src: props.change ? chevronUp : chevronDown, alt: props.change ? 'up' : 'down' }),
